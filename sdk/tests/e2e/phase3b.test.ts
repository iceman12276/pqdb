/**
 * Phase 3b E2E tests — Vector search, Realtime subscriptions.
 *
 ...
 *
 * MCP tests (1-3) live in /mcp/tests/e2e/phase3b-mcp.test.ts because
 * they depend on @modelcontextprotocol/sdk which is in the mcp workspace.
 */
